...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "v2.6.0"
  WORKING_DIRECTORY "C:/Users/ramga/Desktop/bgu/BGR/STM32 Platform/tests/unity"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/ramga/Desktop/bgu/BGR/STM32 Platform/tests/unity'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/ramga/Desktop/bgu/BGR/STM32 Platform/tests/unity'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
